...
export default {
  ...
  attach(context, settings) {
    (function ($) {
      ...
      $('.news-social-media').prepend('<div class="widget-wrapper-print"><a href="" class="share-print"><img src="' + socialImagePath + '/soe_print_icon_gray.svg" alt="print article"></a></div>');
